...
RUN apt-get update && apt-get upgrade -yq
RUN apt-get install git webhookd composer jq php-mysql php-common php-cli php-xml php-curl php-bcmath php-bz2 php-mbstring php-zip php-intl openssh-client -yq
